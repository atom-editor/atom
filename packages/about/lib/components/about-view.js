...
module.exports = class AboutView extends EtchComponent {
  ...
  handleHowToUpdateClick(e) {
    e.preventDefault();
    shell.openExternal(
      'https://flight-manual.atom.camp/getting-started/sections/installing-atom/'
    );
  }
    ...
    return $.div(
      ...
      $.div(
        ...
        $.header(
          ...
          $.a(
            { className: 'about-atom-io', href: 'https://atom.camp' },
            $(AtomLogo)
          ),
          $.div(
      ...
      $.div(
        ...
        $.a(
          { href: 'https://github.com/atom-editor/atom/contributors' },
          'Atom Community'
        )
      )
    );
