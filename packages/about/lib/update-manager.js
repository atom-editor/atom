...
let UpdateManager = class UpdateManager {
  ...
  listenForAtomEvents() {
    ...
    // TODO: When https://github.com/atom-editor/electron/issues/4587 is closed we can add this support.
  ...
  getReleaseNotesURLForVersion(appVersion) {
    ...
    if (appVersion.indexOf('dev') > -1) {
      return 'https://atom.camp/releases';
    }
    ...
    return `https://github.com/atom-editor/${releaseRepo}/releases/tag/${appVersion}`;
  }
};
