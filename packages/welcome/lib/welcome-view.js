      ...
      <div className="welcome">
        <div className="welcome-container">
          ...
          <section className="welcome-panel">
            ...
            <ul>
              ...
              <li>
                The Atom forum at{' '}
                <a
                  href="https://github.com/atom-editor/atom/discussions"
              ...
              <li>
                The{' '}
                <a
                  href="https://github.com/atom-editor"
          ...
          <footer className="welcome-footer">
            <a href="https://atom.camp/" dataset={{ event: 'footer-atom-io' }}>
              atom.camp
            </a>{' '}
