...
I think this is best illustrated by example. [Here’s a ticket](https://github.com/atom-editor/language-javascript/issues/615) from `language-javascript` about syntax highlighting of imports. For example:
