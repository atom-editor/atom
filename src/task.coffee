...
#
# Used by the fuzzy-finder and [find in project](https://github.com/atom-editor/atom/blob/master/src/scan-handler.coffee).
#
# For a real-world example, see the [scan-handler](https://github.com/atom-editor/atom/blob/master/src/scan-handler.coffee)
# and the [instantiation of the task](https://github.com/atom-editor/atom/blob/4a20f13162f65afc816b512ad7201e528c3443d7/src/project.coffee#L245).
#
# ## Examples
#
