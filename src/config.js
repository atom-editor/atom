...
// ```
//
// See [package docs](http://flight-manual.atom.camp/hacking-atom/sections/package-word-count/) for
// more info.
//
// ## Config Schemas
//
...
// * **bold** - `**bold**`
// * *italics* - `*italics*`
// * [links](https://atom.camp) - `[links](https://atom.camp)`
...
class Config {
  ...
  */
  ...
  //     See [the scopes docs](http://flight-manual.atom.camp/behind-atom/sections/scoped-settings-scopes-and-scope-descriptors/)
  ...
  observe(...args) {
    ...
    if (args.length === 2) {
      ...
      console.error(
        'An unsupported form of Config::observe is being used. See https://atom.camp/docs/api/latest/Config for details'
      );
      return;
    }
