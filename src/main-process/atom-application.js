...
module.exports = class AtomApplication extends EventEmitter {
  ...
  handleEvents() {
    ...
    this.on('application:open-documentation', () =>
      shell.openExternal('http://flight-manual.atom.camp')
    );
    this.on('application:open-discussions', () =>
      shell.openExternal('https://github.com/atom-editor/atom/discussions')
    );
    this.on('application:open-faq', () =>
      shell.openExternal('https://atom.camp/faq')
    );
    this.on('application:open-terms-of-use', () =>
      shell.openExternal('https://atom.camp/terms')
    );
    this.on('application:report-issue', () =>
      shell.openExternal(
        'https://github.com/atom-editor/atom/blob/master/CONTRIBUTING.md#reporting-bugs'
      )
    );
