  ...
  constructor(atomApplication, fileRecoveryService, settings = {}) {
    ...
    const options = {
      ...
      webPreferences: {
        ...
        // (Ref: https://github.com/atom-editor/atom/pull/12696#issuecomment-290496960)
    ...
    // taskbar's icon. See https://github.com/atom-editor/atom/issues/4811 for more.
  ...
  handleEvents() {
    ...
    this.browserWindow.webContents.on('render-process-gone', async () => {
      ...
      const result = await dialog.showMessageBox(this.browserWindow, {
        ...
        detail: 'Please report this issue to https://github.com/atom-editor/atom'
      });
